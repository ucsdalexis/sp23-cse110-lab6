...
class RecipeCard extends HTMLElement {
  ...
  set data(data) {
    ...
    let recipeCard = document.querySelector('recipe-card:not(.finished)');
    let article = recipeCard.shadowRoot.querySelector('article');
    /*
    let counter = 2;
    while (article.textContent.trim().length != 0) {
      recipeCard = document.querySelectorAll('recipe-card')[counter];
      article = recipeCard.shadowRoot.querySelector('article');
      counter++;
    }*/
